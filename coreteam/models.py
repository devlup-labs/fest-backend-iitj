...
class CoreMember(models.Model):
    # Validator
    contact = RegexValidator(regex=r'^(\+91|0)?[6789]\d{9}$',
                             message="Phone number must be in valid format.")
    name = models.CharField(max_length=100)
    position = models.ForeignKey(Vertical, on_delete=models.CASCADE,
                                 related_name='new_position')
    image = models.ImageField(upload_to='images/coreteam/',
                              default="""https://as1.ftcdn.net/v2/jpg/03/46/83/96/1000_F_346839683
                              _6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg""")
